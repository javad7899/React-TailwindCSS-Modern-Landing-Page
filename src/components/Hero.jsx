...
const Hero = () => {
  return (
    ...
    >
      ...
      >
        <div className="flex flex-row item-center py-[6px] px-4 bg-discount-gradient  rounded-[8px] mb-2">
        ...
        <h1 className=" font-semibold ss:text-[68px] text-[52px]  text-white ss:leading-[100px] leading-[75px] 2-full">
          Payment Method
        </h1>
